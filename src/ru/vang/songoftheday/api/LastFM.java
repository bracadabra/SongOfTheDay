...
public final class LastFM {
    ...
    private static final String GET_SIMILAR =
            "http://ws.audioscrobbler.com/2.0/?method=track.getsimilar&artist=%s&track=%s&limit="
                    + SongOfTheDaySettings.LAST_FM_LIMIT
                    + "&api_key="
                    + API_KEY
                    + "&autocorrect=1";

    private static final String GET_TOP_TRACKS =
            "http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&limit="
